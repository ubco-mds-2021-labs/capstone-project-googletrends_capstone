        ...
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(html.Div([
                    ...
                    #dbc.CardImg(src="../../assets/ubc.png", top=True)
                    ],
                ...
                html.Div([
                    ...
                    html.Br(),
                    html.H4(children ='Dataset used'),
                    html.H6(children = 'Data set for this project are open ended and the short description about data is provided below:'),
                    html.H6(children = '1. Gross Domestic Product (GDP):',  style={"font-size": "20px", "text-decoration": "underline", "color": "red"}),
                    html.H6(children = 'This dataset is a comma separated file containing the information about the monthly GDP. Link of file is as below:'),
                    dcc.Markdown('''[Gross Domestic Product](https://www150.statcan.gc.ca/t1/tbl1/en/tv.action?pid=3610010401)'''),
                    html.H6(children = '2. Retail Trade Sales:',  style={"font-size": "20px", "text-decoration": "underline","color":"#F5B041 "}),
                    ...
                    dcc.Markdown('''[Retail Trade Sales](https://www150.statcan.gc.ca/t1/tbl1/en/tv.action?pid=2010000802)'''),
                    html.H6(children = '3. E - Commerce:',  style={"font-size": "20px", "text-decoration": "underline","color":"green"}),
                    html.H6(children = 'This is a comma separated dataset containing the information about the retail e-commerce sales. Link of file is as below:'),
                    dcc.Markdown('''[E - Commerce](https://www150.statcan.gc.ca/t1/tbl1/en/tv.action?pid=2010007201)'''),
                    html.H6(children = '4. Google Trends API:',  style={"font-size": "20px", "text-decoration": "underline","color":"#2980B9"}),
                    ...
                    dcc.Markdown('''[Google Trends](https://trends.google.com/trends/?geo=CA)'''),
