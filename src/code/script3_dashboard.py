...
left_partition = html.Div([
    ...
    "The purpose of dashboard is to visualize nowcasting of economic indicators: Gross Domestic Product (GDP), Retail Trade Sales (RTS) and E-Commerce Sales (EC Sales)."),
                           ...
                           html.H6("Understand historical variations in indicator`s growth rate and actual values."),
                           html.Br(),
                           html.H6("Visualize rolling predictions and prediction interval for selected indicator."),
                           html.Br(),
