...
left_partition = html.Div([
                           ...
                           html.H5("Capture Information"),
                           html.Br(),

                           html.H6(
    "The dashboard is for nowcasting the economic indicators: Gross Domestic Product (GDP), Retail Trade Sales (RTS) and E-Commerce Sales (EC Sales)."),
                           ...
                           html.H6("- Understand the indicator`s growth rate and actual values variations over the past years"),
                           html.H6("- Visualize the model fitting"),
                           html.H6("- Visualize the rolling predictions for the selected indicator"),
                           html.H6("- Visualize and observe the prediction interval"),
                           html.H6("- Capture the predicted error obtained from the model fitting"),
                           html.H6("- Capture the indicator`s nowcasted growth rate and actual values for the next period"),
                           html.H6("- Download the Keywords used for the nowcasting from the Google Trends, by clicking the download buttons."),
